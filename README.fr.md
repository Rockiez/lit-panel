...
L’entrée de clôture `verify_quotes.py` et l’audit autonome `verify-quotes.py` partagent le même moteur Tier 1–5. Tier 1 exact, Tier 2 normalisé et Tier 3 avec ellipses soumises à une longueur minimale peuvent valider ; Tier 4 ne produit qu’un candidat non validé pour arbitrage humain et Tier 5 invalide définitivement. Le reçu structuré conserve le tier réel, et Tier 4/5 n’entre jamais dans la dérivation des bandes.
