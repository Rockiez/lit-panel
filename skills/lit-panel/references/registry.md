...
| `standard` | 01–08 | 默认预设。覆盖忠实、一致性、AI 痕迹、四席文学核心中的前四（04/05/06/07）+ 素读者，但不含 09（原创性）/10/11。 |
| `full` | 01–11 | 全席位，含条件激活席（01/10 视输入是否满足；11 默认开启，在 full 下本就在范围内，因此"默认开启覆盖"对 full 没有额外效果）。 |
