...
Les quatre dimensions littéraires partent de 70 et gagnent des bonus selon la proportion vérifiée de leurs critères positifs de métier (+20 pour l’ensemble complet, +12 dès 60 %, +6 dès 30 %), avec retraits mécaniques pour les problèmes core/extended et plafonds veto. La propreté IA part de 100, l’expérience lecteur de 85, et l’originalité ajoute +5, +3 ou +0 sans jamais retrancher. Le total est `min(moyenne littéraire − retrait IA, dimension littéraire la plus faible)` plus le bonus d’originalité ; la bande A exige en outre que chaque siège central vérifie ≥60 % de son ensemble de métier (sinon « B d’archive » clairement annotée), et les sièges 04-07 émettent une comparaison ancrée contre `band-{a,b,c}.md` dont une divergence ≥2 rangs part en arbitrage humain. Le plafond final de fidélité est 75 pour B et 45 pour C lorsque la source est fournie. Les classes de la vue 0-100 vont de A à D. **Les scores sont mécaniquement dérivés des vecteurs de critères ; les sièges ne produisent aucun nombre.**
